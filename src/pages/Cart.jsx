                ...
                cart.length > 0 ?
                    (
                        <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row justify-center">
                            <div lassName="w-[100%] md:w-[60%] flex flex-col p-2">
                                {
                                    cart.map((item, index) => {
                                        return <Cardsitem key={item.id} item={item} itemIndex={index} />
                                    })
                                }
                            </div>
                    ...
                    (<div className="min-h-[80vh] flex flex-col items-center justify-center">
                        ...
                        <Link to={"/"}>
                            <button  className="uppercase bg-green-600 hover:bg-purple-50 rounded-lg text-white transition duration-300 ease-linear mt-5 border-2 border-green-600 font-semibold hover:text-green-700 p-3 px-10 tracking-wider"> Shop Now</button></Link>
                    </div>
